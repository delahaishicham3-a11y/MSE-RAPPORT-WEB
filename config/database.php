<?php
/**
 * Configuration de la base de données PostgreSQL (Render) avec support des photos
 */
...
class Database {
    ...
    private function __construct() {
        // Render fournit DATABASE_URL automatiquement dans l'environnement
        $dbUrl = getenv('DATABASE_URL');

        if ($dbUrl) {
            // Exemple Render : postgresql://user:password@host:port/dbname
